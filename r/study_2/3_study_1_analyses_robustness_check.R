...
study <- read_csv("data/study_2/study.csv")
study_long <- read_csv("data/study_2/study_long.csv")
...
# remembered aspects of study 1
mean(study$remembered)
sd(study$remembered)

# similarity of aspects of study 1 and those of study 2
mean(study$similarity)
sd(study$similarity)
...
ggsave("plots/study_2/n_aspects_distribution.pdf",
       width = 8, height = 6)
...
ggsave("plots/study_2/pro_ratio_distribution.pdf",
       width = 8, height = 6)
...
ggsave("plots/study_2/pro_contra_distribution.pdf",
       width = 8, height = 6)
...
ggsave("plots/study_2/soe_distribution.pdf",
       width = 8, height = 6)
...
ggsave("plots/study_2/SOEP_distribution.pdf",
       width = 8, height = 6)
...
ggsave("plots/study_2/evidencestrength_propensity_correlations.pdf",
       width = 9, height = 7)
...
ggsave("plots/study_2/evidencestrength_propensity_corrs_grid.pdf",
       width = 14, height = 8)
...
pdf("plots/study_2/ratings_variation.pdf", width = 8, height = 6)
p_risk 
dev.off()

### RQ1: Modeling self-reported risk-taking propensity =========================

### Fit models with all data of study 1 and predict data of study 2
rob_check <- rob_s1(study_long_s1, study_s1, study_long, study)
rob_check$rsqs

# VUM parameter
rob_check$parameters$phi

# QT parameters
print(paste0("N contra: ", round(rob_check$parameters$QT_na, 3), " [",
             round(rob_check$parameters$QT_na_lower, 3),
             ", ", round(rob_check$parameters$QT_na_upper, 3), "]"))
print(paste0("N pro: ", round(rob_check$parameters$QT_ns, 3), " [",
             round(rob_check$parameters$QT_ns_lower, 3),
             ", ", round(rob_check$parameters$QT_ns_upper, 3), "]"))
print(paste0("SMRD: ", round(rob_check$parameters$QT_SMRD, 3), " [",
             round(rob_check$parameters$QT_SMRD_lower, 3),
             ", ", round(rob_check$parameters$QT_SMRD_upper, 3), "]"))
...
ggsave("plots/study_2/predictions_models.pdf",
       width = 8, height = 6)
...
ggsave("plots/study_2/predictions_models_mult_asp.pdf",
       width = 8, height = 6)
...
### Plot ---
pdf("plots/study_2/rsq_phi.pdf", height = 4, width = 12)
...
pdf("plots/study_2/contents_distributions.pdf",
    width = 12, height = 6)
...
pdf("plots/study_2/contents_distributions_pro_vs_contra.pdf",
    width = 12, height = 6)
...
pdf("plots/study_2/contents_stacked_barplots.pdf",
    width = 12, height = 8)
